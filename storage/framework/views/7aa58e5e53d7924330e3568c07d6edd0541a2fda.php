        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/mobilization.png')); ?>" width="45" alt="responsive img">
                    <h4>Mobilization</h4>
                    <p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/tradetest.png')); ?>" width="45" alt="responsive img">
                    <h4>Trade Test</h4>
                    <p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/pre-screening.png')); ?>" width="45" alt="responsive img">
                    <h4>Pre-Screen</h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/selection.png')); ?>" width="45" alt="responsive img">
                    <h4>Selection</h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/travel-document.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/reports.png')); ?>" width="45" alt="responsive img">
                    <h4>Reports</h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/deployment.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/preflight-briefing.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/airline-tickets.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/client-accommodation.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/airport.png')); ?>" width="45" alt="responsive img">
                    <h4>Airport</h4>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 service" style="padding-bottom: 30px;">
                <div class="service-widget foo" data-sr='enter'>
                    <img src="<?php echo e(asset('public/web/img/serviceIcon/deployment-period.png')); ?>" width="45" alt="responsive img">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-12 col-md-5">
                        <div class="item">
                            <img src="<?php echo e(asset('public/web/img/homePage/service.jpg')); ?>" alt="responsive img">
                        </div>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('web.layouts.subDefault', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eastymap/public_html/resources/views/web/services.blade.php ENDPATH**/ ?>
                        ...
                        <div class="sidebar-list">
                            <ul class="categories-list" id="myUL">
                                <li class="<?php echo e(empty(app('request')->input('category_id')) ? 'activeCategory' : ' '); ?>">
                                    <a url="<?php echo e(route('viewAjaxJobList')); ?>" class="category makePointer">
                                        All
                                    </a>
                                </li>
                                <?php if(count($jobCategories)>0): ?>
                                    <?php $__currentLoopData = $jobCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($category->total_job != 0): ?>
                                        <li class="<?php echo e(!empty(app('request')->input('category_id')) && $category->id == app('request')->input('category_id') ? 'activeCategory' : ' '); ?>">
                                            <a url="<?php echo e(route('viewAjaxJobList', ['category_id'=>$category->id])); ?>" class="category makePointer">
...
<?php echo $__env->make('web.layouts.subDefault', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eastymap/public_html/resources/views/web/jobOpening.blade.php ENDPATH**/ ?>
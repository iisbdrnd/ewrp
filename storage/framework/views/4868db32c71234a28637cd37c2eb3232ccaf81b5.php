  ...
  <div class="form-group"> 
    <div class="row mt15">
        <div class="col-sm-12">
            ...
            <?php $__currentLoopData = $albumImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $album): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                  <li id="<?php echo e($album->id); ?>" >
                    <div class="box nostatus">
                        <img class="img-thumbnail" src="<?php echo e(url('public/uploads/gallery/'.$album->gallery_thumb)); ?>">
                    </div>
    ...
    $(document).ready(function() {
        $( "#sortable" ).sortable({
          beforeStop: function( event, ui ) {
                ...
                $.ajax({
                    url: '<?php echo e(route("provider.eastWest.galleryAlbumSorting")); ?>',
...
</script><?php /**PATH /home/eastymap/public_html/resources/views/provider/eastWest/gallery/sorting.blade.php ENDPATH**/ ?>
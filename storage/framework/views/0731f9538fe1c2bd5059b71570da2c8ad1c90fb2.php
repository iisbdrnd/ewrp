                    ...
                    <div class="widget-area foo" data-sr="enter" data-sr-id="1" style="; visibility: visible;  -webkit-transform: translateY(0) scale(1); opacity: 1;transform: translateY(0) scale(1); opacity: 1;-webkit-transition: -webkit-transform 0.8s cubic-bezier(0.6, 0.2, 0.1, 1) 0s, opacity 0.8s cubic-bezier(0.6, 0.2, 0.1, 1) 0s; transition: transform 0.8s cubic-bezier(0.6, 0.2, 0.1, 1) 0s, opacity 0.8s cubic-bezier(0.6, 0.2, 0.1, 1) 0s; ">
                        ...
                        <div class="sidebar-list">
                            <ul class="categories-list">
                                <li class="<?php echo e(empty(app('request')->input('category_id')) ? 'activeCategory' : ' '); ?>">
                                    <a url="<?php echo e(route('viewAjaxNotice')); ?>" class="category makePointer">
                                        All
                                    </a>
                                </li>
                                <?php if(count($noticeCategories)>0): ?>
                                    <?php $__currentLoopData = $noticeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        
                                        <li class="<?php echo e(!empty(app('request')->input('category_id')) && $category->id == app('request')->input('category_id') ? 'activeCategory' : ' '); ?>">
                                            <a url="<?php echo e(route('viewAjaxNotice', ['category_id'=>$category->id])); ?>" class="category makePointer">
                        ...
                        <div class="card-body sidebar-list" id="newsEventParent">
                            <ul class="demo1">
                                <?php if(count($newsEvents) > 0): ?>
                                    <?php $__currentLoopData = $newsEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$newsEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="news-item">
                                            <?php if($newsEvent->news_event_type == 1): ?>
                                                <a href="<?php echo e(url('public/uploads/news_event_attachments/'.$newsEvent->attachment_name)); ?>" target="_blank"><?php echo e($newsEvent->title); ?></a>
                                                <br>
                                            <?php else: ?>
                                                <a href="<?php echo e($newsEvent->external_link); ?>" target="_blank"><?php echo e($newsEvent->title); ?></a>
                                                <br>
                                            <?php endif; ?>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script src="<?php echo e(asset('public/web/js/easy-ticker.min.js')); ?>"></script> 
...
<?php echo $__env->make('web.layouts.subDefault', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eastymap/public_html/resources/views/web/noticeBoard/noticeBoard.blade.php ENDPATH**/ ?>
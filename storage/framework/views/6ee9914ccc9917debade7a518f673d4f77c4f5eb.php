<div class="form-inline">
    ...
    <table cellspacing="0" class="responsive table table-striped table-bordered">
        ...
        <tbody>
        <?php $paginate = $userAccess; ?>
		<?php if(count($userAccess)>0): ?>
			<?php $__currentLoopData = $userAccess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userAccess): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><?php echo e($sn++); ?></td>
					<td><?php echo e($userAccess->menu_name); ?></td>
					<td><?php echo e($userAccess->link_name); ?></td>
					<td><?php echo e($userAccess->module_name); ?></td>
					<td><?php echo e($userAccess->updated_at); ?></td>
				</tr>
...
</div><?php /**PATH /home/eastymap/public_html/resources/views/softAdmin/user/userAccessView.blade.php ENDPATH**/ ?>
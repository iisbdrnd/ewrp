...
<html class=no-js>
    <head>
        ...
        <![endif]-->
        <!-- Fav and touch icons -->
        <link rel="icon" href="<?php echo e(url('public/img/favicon.png')); ?>" type="image/png">
    ...
    <body>
        ...
        <div id=header>
            <nav class="navbar navbar-default" role=navigation>
                <div class=navbar-header><a class=navbar-brand href="<?php echo e(route('softAdmin.master')); ?>" style="margin-right: 0;"><img src="<?php echo asset('public/img/logo_inno.png'); ?>" style="display: inline" width="85"></a></div>
                <div id=navbar-no-collapse class=navbar-no-collapse>
                    ...
                    <ul class="nav navbar-right usernav">
                        <li class=dropdown>
                            <a href=# class="dropdown-toggle avatar" data-toggle=dropdown><img src="<?php echo e(url('public/img/avatar.jpg')); ?>" alt="" class="image"> 
                        ...
                        <li><a href=<?php echo e(route('softAdmin.logout')); ?>><i class="s16 icomoon-icon-exit"></i><span class=txt>Logout</span></a></li>
                    </ul>
                </div>
                <!-- /.nav-collapse -->
            </nav>
        ...
        <script src="<?php echo e(route('softAdmin.setUrl')); ?>"></script>
        ...
        <!--[if lt IE 9]>
        <script type="text/javascript" src="<?php echo asset('public/js/libs/excanvas.min.js'); ?>"></script>
        <script type="text/javascript" src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <script type="text/javascript" src="<?php echo asset('public/js/libs/respond.min.js'); ?>"></script>
        <![endif]-->
        ...
        <script src="<?php echo asset('public/public/js/hideShowPassword.min.js'); ?>"></script>
        <!-- Bootstrap DatePicker -->
        <script type="text/javascript" src="<?php echo asset('public/public/plugins/bootstrap-datetimepicker/moment-with-locales.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo asset('public/public/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js'); ?>"></script>
    </body>
</html>
            

<?php /**PATH /home/eastymap/public_html/resources/views/softAdmin/master.blade.php ENDPATH**/ ?>
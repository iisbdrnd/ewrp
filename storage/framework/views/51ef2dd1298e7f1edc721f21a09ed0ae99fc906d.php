...
<form type="update" id="managementTeamForm" panelTitle="<?php echo e($panelTitle); ?>" class="form-load form-horizontal group-border stripped">
    <?php echo e(csrf_field()); ?>

    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label required">Name</label>
        <div class="col-lg-8 col-md-6">
            <input autofocus required name="name" placeholder="Name" value="<?php echo e($managementTeam->name); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label required">Designation</label>
        <div class="col-lg-8 col-md-6">
            <input autofocus required name="designation" placeholder="Designation" value="<?php echo e($managementTeam->designation); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label required">Address</label>
        <div class="col-lg-8 col-md-6">
            <textarea required id="address" name="address" rows="3" class="form-control"><?php echo e($managementTeam->address); ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label">Phone</label>
        <div class="col-lg-8 col-md-6">
            <input autofocus name="phone" placeholder="01xxxxxxxxx" value="<?php echo e($managementTeam->phone); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label">Email</label>
        <div class="col-lg-8 col-md-6">
            <input type="email" autofocus name="email" placeholder="Email" value="<?php echo e($managementTeam->email); ?>" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group col-lg-12 col-md-12 col-xs-12">
        ...
        <div class="image-editor col-lg-3 col-md-3">
            ...
            <input class="form-control"  type="hidden" id="real_image" name="real_image" value="<?php echo e($base64); ?>">
        </div>
    </div>
    <div class="form-group">
...
<script>
    $(document).ready(function() {    
        ...
        $('.image-editor').cropit({
            imageState: {
                src: "<?php echo e(url('public/uploads/managementTeam/'.$managementTeam->image)); ?>",
            },
        });
...
</script><?php /**PATH /home/eastymap/public_html/resources/views/provider/eastWest/managementTeam/update.blade.php ENDPATH**/ ?>
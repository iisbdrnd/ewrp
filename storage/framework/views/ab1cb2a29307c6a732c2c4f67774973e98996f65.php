        ...
        <div class="form-inline">
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                <thead>
                    <tr>
                        <th width="5%">No.</th>
                        <th width="50%" data="1">Title</th>
                        <th width="20%" data="2">Category</th>
                ...
                <?php $__currentLoopData = $noticeList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($notice->notice_category_name); ?></td>
...
<?php /**PATH /home/eastymap/public_html/resources/views/provider/eastWest/noticeBoard/listData.blade.php ENDPATH**/ ?>
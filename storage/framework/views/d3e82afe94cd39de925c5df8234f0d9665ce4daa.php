            ...
            <div class=row>
                <div class=navbar>
                    <div class="container text-center">
                        <a class=navbar-brand href="" style="margin-right: 0;"><img src="<?php echo asset('public/img/logo_inno.png'); ?>" style="display: inline;"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                <div class=panel-body>
                    <form class="form-horizontal mt0" action="<?php echo e(route('softAdmin.login')); ?>" method="post" id=login-form role=form>
                    <?php echo csrf_field(); ?>
                        ...
                        <div class=form-group>
                            ...
                            <div class=col-lg-12>
                                <div class="input-group input-icon">
                                    <input name=username id=username class=form-control placeholder="username" autofocus>
...
</html><?php /**PATH /home/eastymap/public_html/resources/views/softAdmin/login.blade.php ENDPATH**/ ?>
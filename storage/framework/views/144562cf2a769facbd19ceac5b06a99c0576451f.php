        ...
        <div class="row mt15">
            <div class="col-sm-12">
                ...
                <ul class="clearfix" id="sortable">
                    <?php $__currentLoopData = $noticeCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    $(document).ready(function() {
        $( "#sortable" ).sortable({
          beforeStop: function( event, ui ) {
                ...
                $.ajax({
                    url: '<?php echo e(route('provider.eastWest.provider.eastWest.noticeCategorySortingAction')); ?>',
...
</script><?php /**PATH /home/eastymap/public_html/resources/views/provider/eastWest/noticeCategory/sorting.blade.php ENDPATH**/ ?>
...
<html lang=en>
    ...
    <body class=login-page>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                <div class=panel-body>
                    <form class="form-horizontal mt0" action="{{url('email_verification')}}" method="post" id="login-form" role=form>
                    {!! csrf_field() !!}
        ...
        <div class=container>
            <div class=footer>
                <p class=text-center>Copyrights &copy; {{date('Y')}} Copyright <a href="http://www.iisbd.com/" class="color-blue strong" target=_blank>INNOVATION information system</a>. All right reserved !!!</p>
            </div>
        </div>
        <!-- Javascripts -->

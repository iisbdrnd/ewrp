            ...
            <div class=row>
                <div class=navbar>
                    <div class="container text-center">
                        ...
                        <a class=navbar-brand href="{{url('passwordUpdate')}}" style="margin-right: 0;"><img src="{!! asset('public/img/logo.png') !!}" style="display: inline; height: 50px;"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                <div class=panel-body>
                    <form class="form-horizontal mt0" action="{{route('forgotPasswordAction')}}" method="post" id="login-form" role=form>
                    {!! csrf_field() !!}
						{!!session('message')!!}
                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb25">
                                ...
                                <a href="login" class="ajax-link"> <button href="{{route('login')}}" type="button" class="btn btn-default ajax-link" style="float:right">Go To Login</button></a>
                            </div>
                        </div>
                    </form>
                </div>

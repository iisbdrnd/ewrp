<?php $panelTitle = "Received Voucher"; ?>
@include("panelStart")
<div class="row mt15">
    <!-- For Payment Add -->
    <form id="receivedVoucherAddForm" method="post" type="create" class="form-load form-horizontal" data-fv-excluded="" callback="refresh_accounts_area">
        {{csrf_field()}}
        ...
        <div class="col-lg-12 col-md-12 btn-pb15">
            <button type="submit" class="btn btn-default">Save Received Voucher</button>
        </div>
    </from>
</div>
@include("panelEnd")
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#receivedVoucherAddForm").formValidation();
    ...
    $("#ew_project_id").on('change', function(e) {
        $("#receivedVoucherAddForm").find("#remarks").val('');
    });
    ...
    function genRemarks(){
        ...
        if (projectName && transactionBy && totalAmount && accountCode) {
            var remarks = 'Project: '+projectName+'-Accounts: '+accountCode+'- Payment by: '+transactionBy+'- Total Amount: '+totalAmount+' Tk.';
            $("#remarks").val(remarks);
        }
    }

    ...
    <body>
        <div class="container">
            ...
            <div class="header">
                ...
                <p class="title">Collectable Expense @if($date_range==1){{'upto '.$date}}@elseif($date_range==2){{'from '.$from_date.' to '.$to_date}}@endif</p>
            </div>
                ...
                @if($group_report==1)
                    ...
                    <table class="table table-responsive">
                        ...
                        @foreach($ledgers[0] as $ledger)
                            <?php
                                $total_amount += $ledger->expAmount;
                            ?>
                            <tr>
                                <td>{{$ledger->account_code.'-'.$ledger->account_head}}</td>
                                <td class="text-right">{{number_format($ledger->expAmount,2)}}</td>
                            </tr>
                        @endforeach

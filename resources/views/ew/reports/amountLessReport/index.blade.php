<?php $panelTitle = "Amount Less Report"; ?>
@include("panelStart")
<form id="amountLessReportForm" method="post" panelTitle="{{$panelTitle}}" type="view" class="form-horizontal" data-fv-excluded="">
    {{csrf_field()}}
    <div class="row mt15">
        <div class="col-lg-12 col-md-12 col-xs-12">
            ...
            <div class="col-lg-6 col-md-12 sortable-layout candidateInfo">
                <div class="panel panel-default chart">
                    <div class="panel-body">
                        <div class="simple-chart" style="line-height: 29px;">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-3 col-xs-5">Project Name</div>
                                <div class="col-md-9 col-sm-9 col-xs-7">: <span class="projectName"></span></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
            ...
            if (ew_project_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#amountLessReportForm').formValidation('addField', $('#candidate_id'));
        ...
        //Candidate's Details
        $("#amountLessReportForm").on('change', '#candidate_id', function(e) {
        ...
        $("#amountLessReportForm").formValidation().on('success.form.fv', function(e) {
            e.preventDefault();
            ...
            var url = "{{route('ew.amountLessReportData')}}"+'?candidate='+candidate+'&referenceId='+referenceId+'&projectId='+projectId;

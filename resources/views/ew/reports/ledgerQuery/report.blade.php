    ...
    <body>
        <div class="container">
            ...
            <div class="header">
                ...
                <p class="title">Ledger of {{$account->account_head}} @if(isset($opening_date)) {{' ('.$from_date.' - '.$to_date.')'}} @endif </p>
            </div>
            <div class="report-data">
                <table class="table table-responsive">
                    ...
                    @foreach($ledgers as $ledger)
                        <?php
                            /*$contra_account_codes = explode(',', $ledger->contra_account_code);
                            foreach($contra_account_codes as $key=>$code) {
                                $contra_account_codes[$key] = $chart_of_accounts[$code]->account_head;
                            }
                            $particulars = implode(', ', $contra_account_codes);*/

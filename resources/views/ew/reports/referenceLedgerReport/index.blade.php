<?php $panelTitle = "Reference Ledger Book"; ?>
@include("panelStart")
<div class="row mt15">
    <!-- For Payment Add -->
    <form id="referenceLedgerForm" method="post" type="view" class="form-horizontal" data-fv-excluded="">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="form-group">
                <label class="col-lg-4 col-md-4 control-label required">Reference</label>
                <div class="col-lg-4 col-md-4">
                  <select required id="reference_id" name="reference_id" data-fv-icon="false" class="select2 form-control ml0">
                        <option value=""></option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#referenceLedgerForm").formValidation().on('success.form.fv', function(e) {
            ...
            var url = "{{route('ew.referenceLedgerReportData')}}"+'?projectId='+projectId+'&referenceId='+referenceId;

<?php $panelTitle = "Payment Voucher"; ?>
@include("panelStart")
<div class="row mt15">
    <!-- For Payment Add -->
    <form id="paymentVoucherAddForm" method="post" type="create" class="form-load form-horizontal" data-fv-excluded="" callback="refresh_accounts_area">
        ...
        <div class="col-lg-12 col-md-12 btn-pb15">
            <button type="submit" class="btn btn-default">Save Payment Voucher</button>
        </div>
    </from>
</div>
@include("panelEnd")
...
<script type="text/javascript">
    ...
    function genRemarks(){
        ...
        var accountHeads = '';
        var totalAcc = $("#selected_account > tr").length;
        $("#selected_account").find("input[name='account_head[]']").each(function() {
                accountHeads=accountHeads+$(this).val()+', ';
        });

<html moznomarginboxes mozdisallowselectionprint>
    ...
    <body>
        <div class="print_button">
            <button class="btn btn-default" id="deleteTransact"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete The Voucher</button>
        </div>
        @if(count($vouchers)>0)
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#deleteTransact").click(function(e){
                e.preventDefault();
                @if(count($vouchers)>0)
                    var deleteLinkUrl = "{{route('ew.deleteTransactDestroy', [$transaction_no])}}";
                    swal({
                        title: "Are you sure?",

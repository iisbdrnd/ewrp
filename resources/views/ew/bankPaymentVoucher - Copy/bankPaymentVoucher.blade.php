<div class="row mt15">
    ...
    <form id="paymentVoucherAddForm" method="post" type="create" class="form-load form-horizontal" data-fv-excluded="" callback="refresh_accounts_area">
        {{csrf_field()}}
        <div class="col-lg-7 col-md-7 sortable-layout">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="input-group">
                                    ...
                                    <input id="amount" name="amount" placeholder="e.g. 50000.00" class="form-control" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\.]+$" data-fv-regexp-message="Amount can consist of number only">
                                </div>
                            </div>
                            <div class="col-lg-2 col-md-2 pl0 mt10-mbl">
                                <button id="add_amount" type="button" class="btn btn-block btn-default">Add</button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Summary -->
        <div class="col-lg-5 col-md-5 sortable-layout col-no-pl">
            <div class="panel panel-default chart">
                <div class="panel-body">
                    <div class=simple-chart>
                        <div class="form-group">
                            <label class="col-md-4 control-label required">Payment by:</label>
                            <div class="col-md-8">
        ...
        <div class="col-lg-12 col-md-12 btn-pb15">
            <button type="submit" class="btn btn-default btn-mt10">Save Bank Payment Voucher</button>
        </div>
    </from>
</div>
<script type="text/javascript">
    ...
    function genRemarks(){
        ...
        if (projectName && transactionBy && totalAmount && accountCode && chequeNo && chequeDate) {
            var remarks = 'Project: '+projectName+'-Accounts: '+accountCode+'- Payment by: '+transactionBy+'- Check No: '+chequeNo+'- Cheque Date: '+chequeDate+'- Total Amount: ৳'+totalAmount;
            $("#remarks").val(remarks);
        }
    }

<?php $panelTitle = "Amount Received"; ?>
@include("panelStart")
<form id="amountReceiveForm" type="create" panelTitle="{{$panelTitle}}" class="form-load form-horizontal" data-fv-excluded="" callback="refresh_amount_received">
    {{csrf_field()}}
    <div class="row mt15">
            ...
            <div class="panel panel-default chart">
                <div class="panel-body">
                    <div class=simple-chart>
                        ...
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 control-label required">Receive By</label>
                            <div class="col-lg-8 col-md-8">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#amountReceiveForm').formValidation('removeField', $('#cheque_no'));
        $('#amountReceiveForm').formValidation('removeField', $('#cheque_date'));
            ...
            if (ew_project_id) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $('#amountReceiveForm').formValidation('removeField', $('#candidate_id'));
                        $("#project_candidate_id").html(data);
                        $("#candidate_id").select2({ placeholder: "Select" });
                        $('#amountReceiveForm').formValidation('addField', $('#candidate_id'));

                        //Reset
                        $('#amountReceiveForm').formValidation('removeField', $('#account_head'));
                        ...
                        $('#amountReceiveForm').formValidation('addField', $('#account_head'));
        ...
        $("#amountReceiveForm").on('change', '#candidate_id', function(e) {
            var projectId = $("#ew_project_id").val();
            var candidateId = $("#candidate_id").val();
            refresh_candidate_details();
            $.ajax({
                mimeType: 'text/html; charset=utf-8',
        ...
        $("#amountReceiveForm").on('change', '#transaction_by', function(e) {
            var transaction_by=parseInt($(this).val());
            if(bankList.indexOf(transaction_by)>=0) {
                if($("#cheque_no_view").is(":hidden")) {
                    $('#amountReceiveForm').formValidation('addField', $('#cheque_no'));
                    $('#amountReceiveForm').formValidation('addField', $('#cheque_date'));
                    $("#cheque_no_view").show();
        ...
        $("#amountReceiveForm").on('change', '.autoRemarks', function(){
            remarksGen();
        });
    ...
    function remarksGen(){
        ...
        if (project && candidate_id && account_head && amount) {
            var remarksText = account_head+'-'+project+'-'+candidate_id+'- '+'Received Amount '+amount+' Tk.';
    ...
    function refresh_candidate_details(){

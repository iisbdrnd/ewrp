            ...
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                ...
                @foreach($accounts as $account)
                    <tr>
                        ...
                        @if($access->edit || $access->destroy)
                        <td>
                            @if($access->edit)<i class="fa fa-edit" title="Update" view-type="modal" id="edit" data="{{$account->id}}"></i>
                            @endif
                            @if($access->destroy)
                            <i class="fa fa-trash-o" id="delete" data="{{$account->id}}"></i>@endif
                        </td>
                        @endif
                    </tr>
                @endforeach

...
<html class=no-js>
    ...
    <body>
                    ...
                    <ul class="nav navbar-right usernav">
                        ...
                        <li class=dropdown>
                            <a href=# class="dropdown-toggle avatar" data-toggle=dropdown>
                                    ...
                                    @endif
                                <span class=txt>Md.Hiron Mollik</span> <b class=caret></b>
                            </a>
                            <ul class="dropdown-menu right" style="183px !important;">
                                <li class="menu" style="width:175px">
                                    <ul>
                                        ...
                                        <li><a href=#><i class="s16 icomoon-icon-exit"></i><span class=txt>Logout</span></a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
        ...
        <script src="{!! asset('public/js/frame.js') !!}"></script>
        ...
        <script src="{!! asset('public/js/datatable/datatables-init.js') !!}"></script>
        <!--Percentage Loader-->
        <script src="{!! asset('public/plugins/percentageLoader/jquery.percentageloader-0.1.js') !!}"></script>

        <script>
//            $('document').ready(function(){
//                $(".not_access").click(function(){
//                    swal("Cancelled", "Don't have permission for demo software this option", "error");
//                });
//            });
            
            function not_access(){
                swal("Sorry!!", "Don't have permission for demo software!", "error");
            }
                ...
                @if(!empty($notification))
                    if (!Notification) {
                        ...
                        if (Notification.permission !== "granted")
                        {
                            ...
                            notification('{{$notification->url}}', '{{$notification->closeUrl}}', parseInt('{{$notification->time}}'));
                        }
                    }
                @endif
            });

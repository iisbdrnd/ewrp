...
<html lang=en>
    ...
    <body class=login-page>
            ...
            <div class=row>
                <div class=navbar>
                    <div class="container text-center">
                        ...
                        <a class=navbar-brand href="{{url('passwordUpdate')}}" style="margin-right: 0;"><img src="http://202.59.141.34/public/img/logo.png" style="display: inline; height: 50px;"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                <div class=panel-body>
                    <form class="form-horizontal mt0" action="{{route('resetPasswordAction')}}" method="post" id="resetPassword-form" role=form>
                    {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="input-group input-icon">
                                    <input type=password name=confirmPassword id=confirmPassword class=form-control placeholder="password"  required data-fv-identical="true" data-fv-identical-field="password">
                                    <span class=input-group-addon>
                                        <i class="icomoon-icon-lock s16"></i>
                                    </span>
                                </div>
        ...
        <div class=container>
            <div class=footer>
                <p class=text-center>Copyrights &copy; {{date('Y')}} <a href="http://www.iisbd.com/" class="color-blue strong" target=_blank>INNOVATION information system Ltd.</a> All right reserved.</p>
            </div>
        </div>
        <!-- Javascripts -->
        ...
        $(document).ready(function() {
            $('#resetPassword-form').formValidation({
                fields: {
                    password: {
                        validators: {
                            notEmpty: {

         ...
         <div class="error-panel panel panel-default plain animated bounceIn">
            ...
            <div class=panel-body>
               ...
               <div class="text-center">
						@if($isLogin==true)
              <a href="{{route('login')}}"><button type="button" class="btn btn-default">Go To Login</button></a>
						@else 
							<a href="{{route('apps')}}"><button type="button" class="btn btn-default">Go To Apps</button></a>
						@endif
                </div>
            </div>
         </div>

...
<div class="form-inline ">
    <div class="row datatables_header">
        ...
        <div class="col-md-7 col-xs-12">
            ...
            @include("perPageBox") --}}
        <a href="{{ url('recruitment#selection-report') }}" class="ajax-link hand btn btn-sm btn-default pull-right mr5"><i class="fa fa-arrow-left"></i> Back</a>   
        </div>
    </div> 
    <div id=myTabContent2 class=tab-content>
        <div class="tab-pane fade active in" id="home2">
            <div class="form-inline data-table" refresh-url="listOfCV">
                <table id="selectionCandidateList" cellspacing="0" class="responsive table table-striped table-bordered">
                    <thead>
                        <tr>
...
$('#selectionCandidateList').DataTable({
    dom: 'Bfrtip',
    buttons: [
        'csv', 'excel', 'pdf', 'print'
    ]

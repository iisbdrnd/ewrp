            ...
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                ...
                <?php $i++;?>
                    <tr>
                        <td>{{$sn++}}</td>
                        <td>
                             <a href="reports/rejection-candidate-list/{{$project->id}}" menu-active="rejection-report" class="ajax-link hand">
                        ...
                        <td>
                            <a href="reports/rejection-candidate-list/{{$project->id}}" menu-active="rejection-report" class="ajax-link btn btn-sm btn-default">
                               View Rejection List
                            </a>
                        </td>

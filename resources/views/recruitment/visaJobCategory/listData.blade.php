        ...
        <div class="form-inline">
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                <thead>
                    <tr>
                        <th width="5%">No.</th>
                        <th width="40%" data="1">Job Category Name</th>
                ...
                @foreach($jobCategories as $jobCategory)
                    <tr>
                        ...
                        <td>
                            @if($access->edit)
                                <i class="fa fa-edit" title="Update" view-type="modal" id="edit" data="{{$jobCategory->id}}"></i>
                            @endif
                            @if($access->destroy)
                                <i class="fa fa-trash-o" id="delete" data="{{$jobCategory->id}}"></i>
                            @endif
                        </td>
                        @endif
                    </tr>

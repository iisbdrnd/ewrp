                    ...
                    <div class="simple-chart">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <select required id="ew_project_id" name="ew_project_id" data-fv-icon="false" class="select2 form-control ml0 autoRemarks keypressOff">
                                    <option selected value="{{ $candidateInfo->ew_project_id }}" data="5">{{ @Helper::projects($candidateInfo->ew_project_id)->project_name}}</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <select required name="trade_id" id="trade_id" data-fv-icon="false" class="select2 form-control ml0 autoRemarks keypressOff">
                                    <option selected value="{{ $candidateInfo->selected_trade }}">{{ @Helper::singleTrade($candidateInfo->selected_trade)->trade_name}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <select required name="reference_id" id="reference_id" data-fv-icon="false" class="select2 form-control ml0 autoRemarks keypressOff">
                                    <option selected value="{{$candidateInfo->reference_id}}">{{ @Helper::reference($candidateInfo->reference_id)->reference_name }}</option>
                ...
                <div class="panel-body">
                    <div class="simple-chart">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <input autofocus required name="candidate_name" placeholder="Candidate Name" class="form-control keypressOff" value="{{ $candidateInfo->full_name  }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 control-label required">Father Name</label>
                            <div class="col-lg-8 col-md-8">
                                <input autofocus required name="father_name" value="{{ $candidateInfo->father_name }}" placeholder="Father Name" class="form-control keypressOff">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 control-label required">Passport Number</label>
                            <div class="col-lg-8 col-md-8">
                                <input id="passport_number" required autofocus name="passport_number" value="{{ $candidateInfo->passport_no }}"  placeholder="e.g.12A-010" class="form-control keypressOff" kl_virtual_keyboard_secure_input="on" data-fv-regexp="true" data-fv-regexp-regexp="^[0-9+\s\a-z\A-Z]+$"  data-fv-regexp-message="Passport number can consist of number and alphabet.">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 control-label required">National ID</label>
                            <div class="col-lg-8 col-md-8">
                                <input id="national_id" required autofocus name="national_id" value="{{ $candidateInfo->national_id }}" placeholder="e.g.1990-010" class="form-control keypressOff">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="simple-chart">
                        <div class="form-group">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input required name="remarks" id="remarks" placeholder="Remarks" class="form-control keypressOff" data-fv-trigger="keyup change">
                            </div>
                        </div>
                    </div>
                </div>

				...
				<table class="table table-hover">
					<tbody>
						...
						<tr id="visaExpiryDate">
							...
							<td> {{ @Carbon\Carbon::parse($masterTableData->visa_expiry_date)->format('d-m-Y') }} </td>
						</tr>
						<tr id="visaIssuedDate">
							<td><strong>Visa Issued Date:</strong></td>
							<td><span class="text-default">{{ @Carbon\Carbon::parse($masterTableData->visa_issued_date)->format("d-m-Y") }}</span></td>
						</tr>
					</tbody>
				</table>
			</div>

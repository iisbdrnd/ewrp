         ...
         <section id="content1">
            <div class="tabs mb20">
               <ul id="myTab2" class="nav nav-tabs nav-justified">
                  ...
                  <li class=""  id="direct-contact-form"><a href="#directContact" data-toggle="tab" aria-expanded="false">Direct Contact</a></li>
         ...
         <section id="content2">
            <div class="tabs mb20">
               <ul id="myTab2" class="nav nav-tabs nav-justified">
                  ...
                  <li class=""><a href="#direct-contact-details" data-toggle="tab" aria-expanded="false">Direct Contact </a></li>

    ...
    <div class="form-group">
        ...
        <div class="col-lg-10 col-md-9">
            <select required data-fv-icon="false" id="module_id" name="module_id" class="form-control">
                <option value=""></option>
                @foreach($software_modules as $software_module)
                    <option @if($software_menu->module_id==$software_module->id){{'selected'}}@endif value="{{$software_module->id}}">{{$software_module->module_name}}</option>
                @endforeach
            </select>
        </div>
    </div>

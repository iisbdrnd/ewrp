...
<html class=no-js>
    ...
    <body>
            ...
            <nav class="navbar navbar-default" role=navigation>
                ...
                <div id=navbar-no-collapse class=navbar-no-collapse>
                    ...
                    <ul class="nav navbar-right usernav">
                        <li class=dropdown>
                            <a href=# class="dropdown-toggle avatar" data-toggle=dropdown><img src="{{url('public/img/avatar.jpg')}}" alt="" class="image"> 
                                {{-- <span class=txt>{{Auth::admin()->get()->name.' ('.Auth::admin()->get()->username.')'}}</span>  --}}
                                <b class=caret></b></a>
        ...
        <script src="{!! asset('public/public/js/hideShowPassword.min.js') !!}"></script>
        <!-- Bootstrap DatePicker -->
        <script type="text/javascript" src="{!! asset('public/public/plugins/bootstrap-datetimepicker/moment-with-locales.js') !!}"></script>
        <script type="text/javascript" src="{!! asset('public/public/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.js') !!}"></script>
    </body>
</html>

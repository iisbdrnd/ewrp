<div class="form-inline">
    <div class="row datatables_header">
        ...
        <div class="col-md-7 col-xs-12">
            @if(Helper::adminAccess('projectRegistration.create'))
			...
			@foreach($projects as $project)
				<tr>
					...
					<td class="text-center">
                        ...
                        @endif 
                        <button url="projectMailConfiguration" data="{{$project->id}}" class="go-btn btn btn-default btn-xs" type="button">Mail Config.</button>

    ...
    <div class=col-md-8>
        ...
        <div class=row>
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href="activeProjectList" title="I`m with gradient" class="stats-btn tipB mb20"><i class="icon icomoon-icon-users"></i> <span class=txt>Active Projects</span> <span class="notification green">{{count($activeProjects)}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# class="stats-btn mb20"><i class="icon icomoon-icon-support"></i> <span class=txt>Today Expiring Project(s) </span> <span class="notification blue">{{count($todayExpireProjects)}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# title="I`m with pattern" class="stats-btn pattern tipB mb20"><i class="icon icomoon-icon-bubbles-2"></i> <span class=txt>Total Expired Projects</span> <span class="notification">{{count($totalExpiredProjects)}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# class="stats-btn mb20"><i class="icon icomoon-icon-basket"></i> <span class=txt>Total Projects</span> <span class=notification>{{count($totalProjects)}}</span></a>
            </div>
            <!-- / .col-md-3 -->
        </div>
        <div class=row>
            <!-- .row start -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# title="I`m with gradient" class="stats-btn tipB mb20"><i class="icon icomoon-icon-users"></i> <span class=txt>Active Users</span> <span class="notification green">{{$activeUsers}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# class="stats-btn mb20"><i class="icon icomoon-icon-support"></i> <span class=txt>Today Expiring User(s) </span> <span class="notification blue">{{$todayExpireUsers}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# title="I`m with pattern" class="stats-btn pattern tipB mb20"><i class="icon icomoon-icon-bubbles-2"></i> <span class=txt>Total Expired Users</span> <span class="notification">{{$totalExpiredUsers}}</span></a>
            </div>
            <!-- / .col-md-3 -->
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6">
                <!-- .col-md-3 --><a href=# class="stats-btn mb20"><i class="icon icomoon-icon-basket"></i> <span class=txt>Total Users</span> <span class=notification>{{count($totalUsers)}}</span></a>
            </div>
            <!-- / .col-md-3 -->
        </div>
        <!-- / .row -->

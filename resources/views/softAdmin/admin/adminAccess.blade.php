<input id="admin_id" type="hidden" value="{{$admin_info->id}}">
<div class=row>
    <div class="col-lg-12">
        <!-- col-lg-12 start here -->
        <div id="adminAccessPanel" class="panel panel-default panelMove showControls toggle panelClose panelRefresh">
            <!-- Start .panel -->
            <div class="panel-heading">
                <h4 class="panel-title">
                    <div class="checkbox-custom mt0">
                        <input id="checkboxAll" type="checkbox" @if($checkAll){{'checked'}}@endif>
                        <label for="checkboxAll"><strong>All</strong></label>
                    </div>
                </h4>
            </div>
            <div class="panel-body">
                <form id="admin-access-form">
                                                                                                            ...
                                                                                                            @foreach($menu_3->internal_links->chunk(4) as $internal_links)
                                                                                                                <div class="row">
                                                                                                                    @foreach($internal_links as $internal_link)
                                                                                                                        <div class="col-lg-3 col-md-3">
                                                                                                                            <div class="checkbox-custom">
                                                                                                                                <input id="{{'link-checkbox'.$internal_link->id}}" name="internal_link[]" type="checkbox" value="{{$internal_link->id}}" class="{{'check-link'.$menu_3->id}} {{'check'.$menu_1->id}} {{'check'.$menu_2->id}} {{'check'.$menu_3->id}} chk-box">
                                                                                                                                <label for="{{'link-checkbox'.$internal_link->id}}">{{$internal_link->link_name}}</label>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    @endforeach
                                                                                                                                    ...
                                                                                                                                    @foreach($menu_4->internal_links->chunk(4) as $internal_links)
                                                                                                                                        <div class="row">
                                                                                                                                            @foreach($internal_links as $internal_link)
                                                                                                                                                <div class="col-lg-3 col-md-3">
                                                                                                                                                    <div class="checkbox-custom">
                                                                                                                                                        <input id="{{'link-checkbox'.$internal_link->id}}" name="internal_link[]" type="checkbox" value="{{$internal_link->id}}" class="{{'check-link'.$menu_4->id}} {{'check'.$menu_1->id}} {{'check'.$menu_2->id}} {{'check'.$menu_3->id}} {{'check'.$menu_4->id}} chk-box">
                                                                                                                                                        <label for="{{'link-checkbox'.$internal_link->id}}">{{$internal_link->link_name}}</label>
                                                                                                                                                    </div>
                                                                                                                                                </div>
                                                                                                                                            @endforeach
                                                                                                                                                        ...
                                                                                                                                                        @foreach($menu_5->internal_links->chunk(4) as $internal_links)
                                                                                                                                                            <div class="row">
                                                                                                                                                                @foreach($internal_links as $internal_link)
                                                                                                                                                                    <div class="col-lg-3 col-md-3">
                                                                                                                                                                        <div class="checkbox-custom">
                                                                                                                                                                            <input id="{{'link-checkbox'.$internal_link->id}}" name="internal_link[]" type="checkbox" value="{{$internal_link->id}}" class="{{'check-link'.$menu_5->id}} {{'check'.$menu_1->id}} {{'check'.$menu_2->id}} {{'check'.$menu_3->id}} {{'check'.$menu_4->id}} {{'check'.$menu_5->id}} chk-box">
                                                                                                                                                                            <label for="{{'link-checkbox'.$internal_link->id}}">{{$internal_link->link_name}}</label>
                                                                                                                                                                        </div>
                                                                                                                                                                    </div>
                                                                                                                                                                @endforeach
                    ...
                    <div class="row ml0 mt20">
                        {{csrf_field()}}
                        <button id="admin-access-save" class="btn btn-default" type="button">Save Access</button>
                        <button class="back-btn btn btn-default ml15" type="button">Back to List</button>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#adminList").find(".panel-title").first().html('{{$admin_info->name}}');
        $("#adminAccessPanel").checkAll({
        ...
        $("#admin-access-save").click(function(){
            preLoader($("#adminAccessPanel"));
            var data = $("#admin-access-form").serializeArray();
            data[data.length] = {name:'admin', value:$("#admin_id").val()};
            $.ajax({
                url: "{{route('softAdmin.adminAccess')}}",
                type: "POST",
                data: data,
                success: function (data) {
                    ...
                    $.gritter.add({
                        title: "Done !!!",
                        text: "Admin Access has successfully done.",
                        time: "",
                        close_icon: "entypo-icon-cancel s12",
                        icon: "icomoon-icon-checkmark-3",
                        class_name: "success-notice"
                    });
                    preLoaderHide($("#adminAccessPanel"));
                    adminAccessView();
                }
            });
        });

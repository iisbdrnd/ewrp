...
<head>
    ...
    <!-- Prettyphoto Css -->
    <link rel="stylesheet" href="{{asset('public/web/css/prettyPhoto.css')}}">
    <!-- Theme CSS-->
    <link rel="stylesheet" href="{{asset('public/web/css/default.css')}}">
    <link rel="stylesheet" href="{{asset('public/web/css/typography.css')}}">
    <link rel="stylesheet" href="{{asset('public/web/css/style.css')}}">
    <link rel="stylesheet" href="{{asset('public/web/css/responsive.css')}}">
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="{{asset('public/web/img/favicon.png')}}">
    ...
    <style>
        ...
        /* Loader End */
        .page-header{
            background-image: url({{url('public/uploads/banner/'.$banner->banner)}}) ;
        }
        .makePointer{
            cursor: pointer;
        }
...
<body data-spy="scroll" data-target="#scroll-menu" data-offset="65">
    ...
    <div class="preloader-wrap">
        <div class="preloader-inside">
            <div class="spinner spinner-1">
                <img src="{{asset('public/web/img/logo.png')}}" alt="responsive img">
            </div>
        </div>
    </div>
    <!-- End Preloader -->
    ...
    {{-- <div class="social-kit">
        <a href="{{ route('noticeBoard') }}" class="notice_board" target="_blank">
            <img src="{{asset('public/web/img/noticeboard.png')}}" width="29" alt="">
            <i style="margin-left: -5px; font-size: 42px; color: white;" class="fa fa-bell" aria-hidden="true"></i>
        </a>
    </div> --}}
    ...
    <!-- Scripts -->
    <script src="{{asset('public/web/js/jquery-2.1.1.min.js')}}"></script>
    <script src="{{asset('public/web/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('public/web/js/scrollreveal.min.js')}}"></script>
    ...
    <script src="{{asset('public/web/js/isotope_custom.js')}}"></script>
    <!-- Masonary Js -->
    <script src="{{asset('public/web/js/masonry.pkgd.min.js')}}"></script>
    <!-- Prettyphoto js -->
    <script src="{{asset('public/web/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{asset('public/web/js/theme.js')}}"></script>

            ...
            <div class="container">
                <div class="row fullscreen d-flex align-items-center justify-content-center">
                    <div class="col-lg-5  col-md-6 header-right">
                        <h4 class="text-white pb-30">Put your new password</h4>
                        
                        <form id="" class="form" role="form" action="{{route('forgotEmailVerificationAction')}}" method="post" autocomplete="off">
                            @csrf
                            ...
                            <div class="from-group">
                                <input class="form-control txt-field" type="password" name="confirm_password" placeholder="Confirm Password">
                            </div>
                            <div id="errorMsg">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-default btn-lg btn-block text-center text-uppercase">Change Password</button>
                                </div>
                            </div>
                        </form>
                    </div>

	...
	<!-- End  / heading--><!-- Start .row -->
        <div class=row>
                     ...
                     <div id="test" class="row profile">
                              ...
                              <div class=col-md-4>
                                 <div class=profile-avatar>
                                    ...
                                    @else
                                    <img src="{{url('public/uploads/provider_user_images/'.$userProfileDetails->image)}}" alt="Profile Image", style="height:135px; width:135px;">
                                    @endif
                                 </div>
                              </div>
                              <div class="col-md-8 mt20">
                                 <div class=profile-name>
                                    ...
                                    <p class="job-title mb0">{{$projectInfo->company_name}}</p>
                                 </div>
                              </div>
                              <div class="col-md-12 mt15">
                                 ...
                                 <div class="social bt">
                                    <dl class="dl-horizontal mt10 mb0">
                                       ...
                                       <dd><strong>: </strong>{{$userProfileDetails->mobile}}</dd>                                       
                                       <dt><span class="text-muted">Office Phone</span></dt>
               ...
               <div class="tabs mb20">
                  ...
                  <div class="tab-content" id="myTabContent">
                     <div id="update_profile" class="tab-pane fade active in">
                        <form type="update" action="{{route('provider.eastWest.userProfileUpdate')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                           {{csrf_field()}}
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-lg-9">
                                 <input disabled name="designation" id="designation" placeholder="Designation" class="form-control" value="{{$userProfileDetails->designationName}}">
                              </div>
                           </div>
                           <!-- End .form-group  -->
                           <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-lg-9">
                                 <div class=input-group>
                                    <input data-fv-icon="false" name="age" placeholder="Age" class="form-control" data-fv-regexp="true" value="{{$userProfileDetails->age}}"
                                 data-fv-regexp-regexp="^[0-9+\s]+$"  data-fv-regexp-message="Age can consist of number only">
                           ...
                           <div class="form-group form-group-vertical">
                              ...
                              <div class="col-lg-9 col-md-4">
                                 <div class="file-upload" input="image" prefile="{{$userProfileDetails->image}}" filepath="public/uploads/provider_user_images" style="height: 50%; width: 50%;"></div>
                              </div>
                           </div>
                           <!-- End .form-group  -->
                           <div class="form-group">
                     ...
                     <div id="change_password" class="tab-pane fade pb0 mb15">
                        <form type="create" action="{{route('provider.eastWest.changePassword')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                           {{csrf_field()}}
                           <!-- End .form-group  -->
                           <div class="form-group form-group-vertical">
                     ...
                     <div id="timezone" class="tab-pane fade pb0 mb15">
                           <form type="update" action="{{route('provider.eastWest.changeTimeZone')}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                              {{csrf_field()}}
         ...
         <script type="text/javascript">
            ...
            //PROFILE UPDATE THAN REFRESH FULL PAGE FOR RELOAD
            $("#updateProfileButton").click(function(){
               location.reload("{{route('provider.apps')}}");
            });

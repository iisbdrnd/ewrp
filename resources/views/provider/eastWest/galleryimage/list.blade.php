            ...
            <div class=form-group>
                ...
                <div class="col-lg-8 col-md-7 pl0" id="file_attachment">
                    <div class="col-lg-10 col-md-9">
                        ...
                        <button id="file_attachment_upload" input-prefix="image" file-attach-direction="last" callback="photoGalleryList" remove-callback="down_images" file-path="public/uploads/gallery" height="100" width="100" _token="{{ csrf_token() }}" auto-remove="true" type="button" data-loading-text="Uploading..." class="btn btn-info" multiple="true" stroke-url="galleryImageStore" id-parameter="{{$gallery->id}}"> Image Upload</button>

            ...
            <table cellspacing="0" class="responsive table table-striped table-bordered">
                ...
                @foreach($companyPolicies as $companyPolicy)
                    <tr>
                        ...
                        <td>
                            <button url="facilitiesGalleryImage?photo_gallery_id={{$companyPolicy->id}}" main-selector="mainDiv" clone-selector="cloneDiv" data-prefix="cl" panel-title="Invitations of {{$companyPolicy->title}} class" class="go-btn hand btn btn-info btn-xs" stroke-url="facilitiesGalleryImageAction" type="button" style="margin-bottom:6px;">Upload Photo</button> 
                        </td>
                        @if($access->edit || $access->destroy)

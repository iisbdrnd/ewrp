...
<form type="create" id="managementTeamForm" panelTitle="{{$panelTitle}}" class="form-load form-horizontal group-border stripped">
    {{csrf_field()}}
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8 col-md-6">
            <input autofocus name="phone" placeholder="01xxxxxxxxx" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label">Email</label>
        <div class="col-lg-8 col-md-6">
            <input type="email" autofocus name="email" placeholder="Email" class="form-control">
        </div>
    </div>

...
<form type="update" panelTitle="{{$panelTitle}}" class="form-load form-horizontal group-border stripped" data-fv-excluded="">
    ...
    <div class="row mt15">
        <div class="col-sm-12">
            <a class="btn btn-default btn-sm ajax-link" href="managementTeam" type="button" style="margin-left: 12px;">Back to List</a>
        </div>
    </div>
</form>
    ...
    $(document).ready(function() {
        $( "#sortable" ).sortable({
          beforeStop: function( event, ui ) {
                ...
                $.ajax({
                    url: '{{route('provider.eastWest.provider.eastWest.teamSortingAction')}}',

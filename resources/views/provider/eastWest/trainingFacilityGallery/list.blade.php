        ...
        <div class=form-group>
            ...
            <div class="col-lg-8 col-md-7 pl0" id="file_attachment">
                <div class="col-lg-10 col-md-9">
                    ...
                    <button id="head_office_file_attachment_upload" input-prefix="image" file-attach-direction="last" callback="photoGalleryList" remove-callback="down_images" file-path="public/uploads/trainingFacilities" height="100" width="100" _token="{{ csrf_token() }}" auto-remove="true" type="button" data-loading-text="Uploading..." class="btn btn-info" multiple="true" stroke-url="trainingFacilitiesGalleryImageAction" typeOfImage="facility_head_office" id-parameter="1"> Image Upload</button>
...
<script type="text/javascript">
    ...
    function galleryImagesView(gallery_id) {
        var loadUrl = "trainingFacilitiesGalleryImageListData?gallery_id="+gallery_id;

        $('#data-list-view').html($('#data-list-view-clone').html());
        $('#data-list-view').find('.panel-title').html('Gallery Images');
        $('#data-list-view').find('#dataListView').attr("load-url", loadUrl).attr("delete-link", "trainingFacilitiesGalleryImageDestroy");
        $(".dataList-data-input").remove();
        loadDataTable($('#data-list-view').find('#dataListView'), "trainingFacilitiesGalleryImageListData?gallery_id="+gallery_id, false);
    }

...
<form type="update" id="managementTeamForm" panelTitle="{{$panelTitle}}" class="form-load form-horizontal group-border stripped">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-8 col-md-6">
            <input autofocus required name="phone" placeholder="01xxxxxxxxx" value="{{$managementTeam->phone}}" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-lg-2 col-md-3 control-label required">Email</label>
        <div class="col-lg-8 col-md-6">
            <input type="email" autofocus required name="email" placeholder="Email" value="{{$managementTeam->email}}" class="form-control">
        </div>
    </div>

            ...
            <div id="before-panel">
                ...
                @if(!empty($fixedPanel[0]))
                    @foreach($fixedPanel[0] as $panel)
                        ...
                        $refreshUrl = "dashboard/team-dashboard?section=".$panel;
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#dashPanelAdd").click(function(e){
            e.preventDefault();
            var title = "Add";
            var detailsUrl = 'dashPanelList?dashType=2';
    ...
    function dashboardPanelUpdate($notSelector) {
        ...
        if(preLeftSide!=leftSide || preRightSide!=rightSide) {
            ...
            $.ajax({
                ...
                data: {dashType: 2, leftSide: leftSide, rightSide: rightSide, _token: $("input[name='_token']").val()},
                type: 'POST'
            });
        }
    }
    ...
    function panelBox(panel) {
            ...
            var dashPanel = '<div load-url="dashboard/team-dashboard?section='+panel+'"';

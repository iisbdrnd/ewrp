<div class=row>
    <div class="col-lg-12">
        ...
        <div id="empAccessPanel" class="panel panel-default panelMove showControls toggle panelClose panelRefresh">
            <!-- Start .panel -->
            ...
            <div class="panel-body">
                <form id="emp-access-form">
                    ...
                    <div class="row ml0 mt20">
                        {{csrf_field()}}
                        <button id="emp-access-save" class="btn btn-default" type="button">Save Access</button>
                    </div>
                </form>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#emp-access-save").click(function(){
            preLoader($("#empAccessPanel"));
            var data = $("#emp-access-form").serializeArray();
            ...
            $.ajax({
                url: "{{route('provider.admin.employeeAccess')}}",
                type: "POST",
                data: data,
                success: function (data) {
                    ...
                    $.gritter.add({
                        title: "Done !!!",
                        text: "Employee Access has successfully done.",
                        time: "",
                        close_icon: "entypo-icon-cancel s12",
                        icon: "icomoon-icon-checkmark-3",
                        class_name: "success-notice"
                    });
                    preLoaderHide($("#empAccessPanel"));

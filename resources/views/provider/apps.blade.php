            ...
            <div class=row>
                <div class=navbar>
                    ...
                    <div class="container text-center">
                        <a class=navbar-brand style="margin-right: 0;"><img height="40" src="{{ asset('public/uploads/logo/'.$poject_logo) }}" style="display: inline;"></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav navbar-right usernav">
                        <li class="dropdown">
                            <a aria-expanded="false" href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
                                ...
                                @endif
                                <span class="txt">{{Auth::guard('provider')->user()->name}}</span>
                            </a>
                        </li>

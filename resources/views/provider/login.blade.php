...
<html lang=en>
    <head>
        ...
        <!-- Fav and touch icons -->
        <link rel="icon" href="{{ url('web/img/favicon.ico') }}" type="image/png">
    </head>
    ...
    <body class=login-page>
            ...
            <div class=row>
                <div class=navbar>
                    <div class="container text-center">
                        <a class=navbar-brand href="#" style="margin-right: 0;"><img src="{!! asset('public/img/logo_inno.png') !!}" style="display: inline; height: 50px;"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                <div class=panel-body>
                    <form class="form-horizontal mt0" action="{{route('provider.login')}}" method="post" id=login-form role=form>
                    {!! csrf_field() !!}
                        ...
                        <div class=form-group>
                            ...
                            {{-- <span class="col-lg-12 help-block text-right">
                                <a href="{{route('provider.forgotPassword')}}">Forgot password ?</a>
                            </span> --}}
        ...
        <div class=container>
            <div class=footer>
                <p class=text-center>Copyrights &copy; {{date('Y')}} <a href="http://iisbd.com" class="color-blue strong" target=_blank> INNOVATION</a>. All right reserved !!!</p>
            </div>
        </div>
        <!-- Javascripts -->

...
<html lang=en>
    <head>
        <meta charset=utf-8>
        <title>Account Verified | Application Frame</title>
         ...
         <div class="error-panel panel panel-default plain animated bounceIn">
            ...
            <div class=panel-body>
               <div class=page-header>
                   <h3 class="text-center mt30 mb30">
                      <div class="sweet-alert" style="display: contents!important;">
                      ...
                      Your account already verified</h3>
               </div>
               <div class="text-center">
                    <a href="login" class="ajax-link">
                        <button href="{{route('provider.login')}}" type="button" class="btn btn-default ajax-link">Go To Login</button>
                    </a>
                </div>
            </div>
         </div>

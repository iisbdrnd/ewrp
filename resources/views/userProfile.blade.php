            ...
            <div class="tabs mb20">
               ...
               <div class="tab-content" id="myTabContent">
                  <div id="update_profile" class="tab-pane fade active in">
                     <form id="updateProfileForm" type="update" action="{{route('ew.userProfileUpdate', $user_id)}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                        {{csrf_field()}}
                  ...
                  <div id="change_password" class="tab-pane fade pb0 mb15">
                     <form type="create" action="{{route('ew.changePassword', $user_id)}}" data-fv-excluded="" class="form-load form-horizontal group-border stripped">
                        {{csrf_field()}}
                        <!-- End .form-group  -->
                        <div class="form-group form-group-vertical">

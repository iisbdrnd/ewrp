...
class ProjectMailConfigurationController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $data['crmMailConfigaration'] = ProjectMailConfiguration_admin::where('valid', 1)->where('project_id', $project_id)->first();
        
        return view('softAdmin.crmMailConfigaration.create', $data);
    }

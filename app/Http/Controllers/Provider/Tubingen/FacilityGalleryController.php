...
class FacilityGalleryController extends Controller{
    ...
    public function index(Request $request) {
        ...
        return view('provider.eastWest.facilityGallery.list', $data);
    }
    ...
    public function galleryListData(Request $request){
        ...
        return view('provider.eastWest.facilityGallery.listData', $data);
    }
    
    public function create(Request $request){
        $data['inputData'] = $request->all();
        return view('provider.eastWest.facilityGallery.create', $data);
    }
    ...
    public function edit($id){
        ...
        return view('provider.eastWest.facilityGallery.update', $data);
    }
    ...
    public function destroy($id){
        ...
        $images = FacilityHeadOfficeGallery_provider::valid()->where('photo_gallery_id', $photoGallery->id)->get();
    ...
    public function facilitiesGalleryImage(Request $request) {
        $data['inputData'] = $request->all();
        return view('provider.eastWest.facilityGallery.list', $data);
    }
    ...
    public function facilityGalleryImageListData(Request $request){
        ...
        $data['galleryImages'] = FacilityHeadOfficeGallery_provider::valid()->get();
        
        return view('provider.eastWest.facilityGallery.listData', $data);
    }

    public function facilitiesGalleryImageDestroy($id){
        $image = FacilityHeadOfficeGallery_provider::valid()->where('id', $id)->first();

        File::delete(public_path().'/uploads/facilityHeadOffice/'.$image->image_thumb);
        File::delete(public_path().'/uploads/facilityHeadOffice/thumb/'.$image->image_thumb);
    ...
    public function gallerySortingListData (Request $request){
        ...
        return view('provider.eastWest.facilityGallery.sorting', $data);
    }

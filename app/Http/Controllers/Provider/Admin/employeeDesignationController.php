...
class employeeDesignationController extends Controller
{
    ...
    public function designationListData(Request $request) {
        ...
        $data['enProviderDesignations'] = EmployeeDesignation_provider::valid()
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            EmployeeDesignation_provider::create($input);
            $output['messege'] = 'Designation has been created';
            $output['msgType'] = 'success';

            //For In Page Add
            $crmDesignationInfo = EmployeeDesignation_provider::valid()->orderBy('id', 'desc')->first();
    ...
    public function edit($id)
    {
        ...
        $data['adminDesignation'] = EmployeeDesignation_provider::valid()->find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->passes()) {
        EmployeeDesignation_provider::valid()->find($id)->update($input);
    ...
    {
        EmployeeDesignation_provider::valid()->find($id)->delete();
    }
}

...
class TradesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('recruitment.trades.list', $data);
    }
    ...
    public function tradesListData(Request $request) {
        ...
        return view('recruitment.trades.listData', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('recruitment.trades.create', $data);
    }

    public function add()
    {
        
        return view('recruitment.trades.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('recruitment.trades.update', $data);
    }

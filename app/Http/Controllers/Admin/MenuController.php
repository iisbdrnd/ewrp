...
class MenuController extends Controller
{
    ...
    public function menuSorting(Request $request)
    {
        ...
        $data['software_modules'] = SoftwareModules::projectAccessModules($project_id)->chunk(4);
        return view('admin.menu.menuSorting', $data);
    }
    ...
    public function menuSortingMenuList(Request $request)
    {
        ...
        if(!empty($data['software_module'])) {
            $data['software_menus'] = SoftwareMenu::projectAccessMenus($project_id, $module_id);
            return view('admin.menu.menuSortingMenuList', $data);
        }
    }

...
Route::group(['middleware' => 'userAuth'], function() {
    Route::group(['prefix' => 'recruitment', 'as'=>'recruit.'], function (){
        ...
        Route::group(['middleware' => 'projectExpiration'], function (){
            ...
            Route::get('generateMobilizeList', array('access' => ['resource|mobilization-list.index'], 'uses' => 'MobilizationList@generateMobilizeList'));
            ...
            Route::post('create-cv/{projectId}/{projectCountryId}', array('access' => ['resource|interview.index'], 'uses' => 'InterviewController@interviewCreateCVStore'));
             ...
             Route::get('tradeDetails', array('as' => 'tradeDetails', 'access' => ['resource|interview.index'], 'uses' => 'InterviewController@tradeDetails'));
            ...
            */
            ...
            // worker follow up report

            Route::get('worker-follow-up', array('as' => 'workerFollowUp', 'uses' => 'WorkerFollowUpController@workerFollowUpReport'));
            Route::get('projectWiseDealer', array('access' => ['workerFollowUp'], 'as' => 'projectWiseDealer', 'uses' => 'WorkerFollowUpController@projectWiseDealer'));

            Route::get('worker-follow-up-view', array('access' => ['workerFollowUp'], 'as' => 'workerFollowUpView', 'uses' => 'WorkerFollowUpController@workerFollowUpReportView'));
   
            Route::get('worker-follow-up-pdf', array('access' => ['workerFollowUp'], 'as' => 'workerFollowUpPdf', 'uses' => 'WorkerFollowUpController@workerFollowUpReportPdf'));

            // end worder follow up report

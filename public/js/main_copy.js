...
if (function(a, b, c) {
                ...
                function(a, b, d) {
                    TableTools = function(b, c) {
                        ...
                        fnGetTitle: function(a) {
                            ...
                            return "Â¡".toString().length < 4 ? b.replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "") : b.replace(/[^a-zA-Z0-9_\.,\-_ !\(\)]/g, "")
                        },
    ...
    }(jQuery), window.console || (console = { log: function() {} }), navigator.userAgent.match(/IEMobile\/10\.0/)) {

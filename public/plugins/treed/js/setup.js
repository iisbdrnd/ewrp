...
function update(tree, svg, setCollapsed, diagonal, source) {
  ...
  nodeEnter.append("text")
	  ...
	  .attr("class", function(d) { return d.meta.class; })
      .attr("data-original-title", function(d) { return d.meta.dataOriginalTitle; })
      .attr("data-content", function(d) { return d.meta.dataContent; })
      .style("fill-opacity", 1e-6);
	  
  $("#d3view").find(".popoverText").popover({placement: "bottom", html: "true", trigger: "hover", container: $("#example") });
  ...
  nodeUpdate.select("text")
      .text(function(d) {
		  var treeContent = d.content;
		  var treeShortContent = treeContent.substring(0, 13);
		  return (treeContent.length>treeShortContent.length) ? treeShortContent+'...' : treeContent;
	  })

...
ctx.lineWidth=lw;ctx.strokeStyle=series.points.borderColor||series.color;plotPoints(series.datapoints,radius,getFillStyle(series.points,series.color),0,!1,series.xaxis,series.yaxis,symbol);ctx.restore()}
...
if(options.legend.height){var legendH=options.legend.height}else{var legendH=5}
fragments.push('<td class="legendColorBox"><div style="border:1px solid '+options.legend.labelBoxBorderColor+';padding:1px"><div style="width:'+options.legend.width+'px;height:0;border:'+legendH+'px solid '+entry.color+';overflow:hidden"></div></div></td>'+'<td class="legendLabel">'+entry.label+'</td>')}
if(rowStarted)

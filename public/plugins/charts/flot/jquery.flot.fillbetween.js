...
fromgap=!0;j+=otherps}else{px=points[i];py=points[i+1];qx=otherpoints[j];qy=otherpoints[j+1];bottom=0;if(px===qx){for(m=0;m<ps;++m){newpoints.push(points[i+m])}
...
i+=ps}
fromgap=!1;if(l!==newpoints.length&&withbottom){newpoints[l+2]=bottom}}

(function($){var options={crosshair:{mode:null,color:"rgba(170, 0, 0, 0.80)",lineWidth:1}};function init(plot){var crosshair={x:-1,y:-1,locked:!1};plot.setCrosshair=function setCrosshair(pos){if(!pos)
...
plot.setCrosshair(pos);crosshair.locked=!0};plot.unlockCrosshair=function unlockCrosshair(){crosshair.locked=!1};function onMouseOut(e){if(crosshair.locked)

...
define(["../../lib/codemirror"],mod);else mod(CodeMirror)})(function(CodeMirror){CodeMirror.defineOption("showTrailingSpace",!1,function(cm,val,prev){if(prev==CodeMirror.Init)prev=!1;if(prev&&!val)
